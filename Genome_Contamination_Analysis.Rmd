...
![](https://static.inaturalist.org/photos/183037756/original.png)
![](docs/p_colonus_blob_results/linear_plot.png)

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/docs/p_colonus_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_colonus_blob_results/log_plot.png')
```

#### Assembly statistics in a snail plot
```{r include=T}
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_colonus_blob_results/p_colonus_blobt_nb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_colonus_blob_results/p_colonus_blobt_nb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_colonus_blob_results/p_colonus_blobt_nb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_colonus_blob_results/f6235d8a-0f0e-42b2-a6b8-2deeb62a6295.csv",header = T, sep = ",")
library(tidyverse)
...
```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_furcifer_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_furcifer_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_furcifer_blob_results/p_furcifer_blobt_nb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_furcifer_blob_results/p_furcifer_blobt_nb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_furcifer_blob_results/p_furcifer_blobt_nb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/p_furcifer_blob_results/7fc11af9-8af0-4b87-a060-df69dfa56242.csv",header = T, sep = ",")
library(tidyverse)
blob_results<-select(blob_results, -1)
blob_results2<-select(blob_results, 1,8,2,3,7,4,5,6)
blob_results2<-select(blob_results2, -1)
...
```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_fulva_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_fulva_blob_results/log_plot.png')
```

#### Assembly statistics in a snail plot
```{r include=T}
#Snail plot/
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_fulva_blob_results/c_fulva_blobt_nb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_fulva_blob_results/c_fulva_blobt_nb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_fulva_blob_results/c_fulva_blobt_nb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_fulva_blob_results/8e78fbed-8511-4f58-865d-007ee7d110fc.csv",header = T, sep = ",")
#library(tidyverse)
blob_results<-select(blob_results, -1)
blob_results2<-select(blob_results, 1,8,2,3,7,4,5,6)
blob_results2<-select(blob_results2, -1)
...
```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_multilineata_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_multilineata_blob_results/log_plot.png')
```

#### Assembly statistics in a snail plot
```{r include=T}
#Snail plot/
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_multilineata_blob_results/c_multilineata_blobt_nb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_multilineata_blob_results/c_multilineata_blobt_nb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_multilineata_blob_results/c_multilineata_blobt_nb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_multilineata_blob_results/2a719209-31ee-4daa-bf74-cf1424f52538.csv",header = T, sep = ",")
library(tidyverse)
blob_results<-select(blob_results, -1)
blob_results2<-select(blob_results, 1,8,2,3,7,4,5,6)
blob_results2<-select(blob_results2, -1)
...
```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_atrilobata_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_atrilobata_blob_results/log_plot.png')
```

#### Assembly statistics in a snail plot
```{r include=T}
#Snail plot/
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_atrilobata_blob_results/c_atrilobata_blobt_nb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_atrilobata_blob_results/c_atrilobata_blobt_nb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_atrilobata_blob_results/c_atrilobata_blobt_nb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_atrilobata_blob_results/2ba4906a-f4e2-4662-ab36-67bcde2f380f.csv",header = T, sep = ",")
library(tidyverse)
blob_results<-select(blob_results, -1)
blob_results2<-select(blob_results, 1,8,2,3,7,4,5,6)
blob_results2<-select(blob_results2, -1)
...
```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_cynea_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_cynea_blob_results/log_plot.png')
```

#### Assembly statistics in a snail plot
```{r include=T}
#Snail plot/
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_cynea_blob_results/c_cyanea_blobtnb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_cynea_blob_results/c_cyanea_blobtnb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_cynea_blob_results/c_cyanea_blobtnb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/c_cynea_blob_results/cd6a4b7f-9e60-40a2-b3e9-cea95e3f60ee.csv",header = T, sep = ",")
#library(tidyverse)
blob_results<-select(blob_results, -1)
blob_results2<-select(blob_results, 1,8,2,3,7,4,5,6)
blob_results2<-select(blob_results2, -1)
...
```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/a_troshelii_blob_results/linear_plot.png')
```

```{r include=T}
#GenomeScope Resutls
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/a_troshelii_blob_results/log_plot.png')
```
...
```{r include=T}
#Snail plot/
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/a_troshelii_blob_results/a_troshelii_blobt_nb.snail.png')
```
...
```{r}
#cumulative plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/a_troshelii_blob_results/a_troshelii_blobt_nb.cumulative.png')
```
...
```{r}
# blob plot
knitr::include_graphics('C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/a_troshelii_blob_results/a_troshelii_blobt_nb.blob.circle.png')
```
...
```{r eval=T, include=T}
blob_results<- read.csv("C:/Users/USER/Desktop/Panama 2022/Markdown website/Panama Gems/_site/docs/a_troshelii_blob_results/00ff4f5e-bd43-4c48-b4c8-9e2e9b971300.csv",header = T, sep = ",")
#library(tidyverse)
blob_results<-select(blob_results, -1)
blob_results2<-select(blob_results, 1,8,2,3,7,4,5,6)
blob_results2<-select(blob_results2, -1)
